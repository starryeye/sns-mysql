 ...
 * Post like 를 위한 서비스
 *
 * TODO: 한명의 회원은 하나의 게시물에 대해 한번만 좋아요를 누를 수 있는 기능은..
 *  -> DB PostLike Table 의 memberId 에 Unique 제약조건을 걸어서 처리..?
 *  -> Client 에서 처리
 *
...
public class PostLikeWriteService {
    ...
    public Long create(PostDto postDto, MemberDto memberDto) {
        ...
        Long postId = postLikeRepository.save(postLike).getId();

        postRedisDataStore.postLikeIncrement(String.valueOf(postId), 1L);
